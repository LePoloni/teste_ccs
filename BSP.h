 ...
 *	Tornei essa função writedata pública para usar com o SD Card
...
//Defines para uso de funções (incialmente internas) o formato padrão da biblioteca
#define BSP_LCD_setAddrWindow	setAddrWindow
#define BSP_LCD_writedata			writedata
...
//Leandro (01/09/2019) - tornei essa função pública para usar com o SD Card              
...
// same as the ymax and ymin values specified in the
// initialization function.
// Input: data1  start pointof the line to be plotted (units not specified)
...
//Leandro (12/02/2019) - adaptação fa função BSP_LCD_DrawBitmap para trabalhar com 4 bits (1byte por pixel)
...
//Leandro (17/03/2019) - tornei essa função pública para usar com o SD Card              
